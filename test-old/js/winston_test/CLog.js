...
// this example describe tu use Winston library in class context Node.js
                      // import winston dayly logrotate npm package

class CLogs {
    constructor() {
      console.log("CLog.js: constructor: Begin");

      // Configure rotatelog 
      console.log("CLog.js: constructor: constant declaration section");
      ...
      console.log("CLog.js: constructor: logLevel="+logLevel);

      console.log("CLog.js: constructor : createLogger section");
      ...
      const logger = Winston.createLogger({                                             // Create a logger
        ...
        transports: [
          ...
          new Winston.transports.File({                                                 // configure log File Begin
            filename: logFolder+'CLog_test_file.log',                                  // Filename of log file
          }), 
        ], 
      });                                                                               // End createLogger Winston Function

      console.log("CLog.js: constructor : createLogger: End");

      // console.log("CLogs.js: constructor : logger.emergency");
      // logger.emergency('Test Emergency message');                                       // display message emergency level 

      console.log("CLog.js: constructor: End");
    ...
    */
    ...
    Emergency(Msg) {                                                                    // Begin Emergency Winston Function
      console.log("CLog.js: Emergency : Begin");

      logger.emergency('Emergency message');                                            // display message emergency level 

      console.log("CLog.js: Emergency : End");                                         // End Emergency Winston Function
    }  
